...
Canonical source: docs/STATUS-2026-08-02.md
Supersedes: Interim migration notes through 2026-07-30
---

# Legacy production data → RustFS v2 → 2026 stage

This is the current operational record for the data migration and stage
recovery rehearsal. It is separate from historical design documents: those
pages explain the contracts, while this page records what actually happened,
what is verified, and what remains blocked.
...
The following non-secret values are the current stage contract:
    ...
    DATAOPS_PROFILE_PRODUCTION_DATASET_ID=ai-sahakar-prod-v2
    DATAOPS_PROFILE_STAGE_2026_DATASET_ID=ai-sahakar-stage-2026
    BACKUP_ROLE=reader
