...
REASONS = {
    ...
    "writer_environment_required": (
        "Production backup is unavailable here",
        "Only the configured production writer may create or publish backups for its authoritative dataset.",
        "No backup job was created and remote authority remains unchanged.",
        "Review deployed environment settings",
        "configuration",
        "danger",
    ),
    ...
    "vault_sync_disabled": (
        "Production backup is disabled",
        "This deployment is not configured to create immutable Vault backups.",
        "No backup job can be queued until the deployed setting is enabled.",
        "Review deployed environment settings",
        "configuration",
        "warning",
    ),
    "vault_restore_disabled": (
        "Restore preparation is disabled",
        "This deployment is not configured to prepare data from an approved Vault backup.",
        "No restore job can be queued until the deployed setting is enabled.",
        "Review deployed environment settings",
        "configuration",
        "warning",
    ),
    "restore_workspace_ambiguous": (
        "Restore workspace needs specialist review",
        "More than one activation-ready workspace is bound to the latest restore receipt.",
        "Ordinary activation remains blocked to prevent choosing the wrong prepared data.",
