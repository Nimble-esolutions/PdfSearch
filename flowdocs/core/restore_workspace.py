...
VALID_TRANSITIONS: dict[WorkspaceState, set[WorkspaceState]] = {
    ...
    WorkspaceState.PREFLIGHT_PASSED: {WorkspaceState.SANITIZING, WorkspaceState.MIGRATION_REHEARSAL, WorkspaceState.APPLICATION_VALIDATED, WorkspaceState.FAILED, WorkspaceState.PURGED},
    WorkspaceState.SANITIZING: {WorkspaceState.SANITIZED, WorkspaceState.FAILED, WorkspaceState.PURGED},
    WorkspaceState.SANITIZED: {WorkspaceState.MIGRATION_REHEARSAL, WorkspaceState.APPLICATION_VALIDATED, WorkspaceState.FAILED, WorkspaceState.PURGED},
