...
MIDDLEWARE = [
    ...
    'core.canonical_host.CanonicalProductionHostMiddleware',
...
DATAOPS_BACKUP_QUIET_PERIOD_SECONDS = _env_nonnegative_int('DATAOPS_BACKUP_QUIET_PERIOD_SECONDS', 120)
DATAOPS_BACKUP_PROFILE = os.getenv('DATAOPS_BACKUP_PROFILE', '').strip().lower()
DATAOPS_RESTORE_PROFILE = os.getenv('DATAOPS_RESTORE_PROFILE', '').strip().lower()
DATAOPS_BACKUP_SOURCE_PROFILE = os.getenv('DATAOPS_BACKUP_SOURCE_PROFILE', '').strip().lower()
DATAOPS_BACKUP_DESTINATION_PROFILE = os.getenv('DATAOPS_BACKUP_DESTINATION_PROFILE', '').strip().lower()
DATAOPS_RESTORE_SOURCE_PROFILE = os.getenv('DATAOPS_RESTORE_SOURCE_PROFILE', '').strip().lower()
DATAOPS_RESTORE_DESTINATION_PROFILE = os.getenv('DATAOPS_RESTORE_DESTINATION_PROFILE', '').strip().lower()
DATAOPS_PROFILE_MANIFEST = os.getenv('DATAOPS_PROFILE_MANIFEST', '').strip()
...
DATAOPS_AUTO_HEAL_MAX_RETRIES = _env_nonnegative_int('DATAOPS_AUTO_HEAL_MAX_RETRIES', 3)
DATAOPS_OPERATION_LEASE_SECONDS = _env_positive_int('DATAOPS_OPERATION_LEASE_SECONDS', 3600)
...
STAGE_SAME_DATASET_RESTORE_ENABLED = _env_bool(
    'STAGE_SAME_DATASET_RESTORE_ENABLED', False
)
