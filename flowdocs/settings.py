...
# OpenAI
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")   # You already have this, keep it.
OPENAI_EMBED_MODEL = "text-embedding-3-small"
OPENAI_CHAT_MODEL = "gpt-4o-mini"   # Or any available fast model
...
MAX_CONTEXT_WORDS = 2500     # Much smaller = faster GPT responses

# Cached search responses (seconds)
SEARCH_CACHE_TTL = 600       # 10 minutes cache for repeated questions

# Location for FAISS, embeddings, and index files
